...
Faiza | Abdallah | 31 Mars 1996 | Mayotte | Francaise

#Donnees_bien
#$ADRESSE_BIEN | $DESIGNATION | $TYPE
2eme etage a gauche, 3 rue Lafaurie 09000 Foix | un appartement de type T2, comprenant une chambre, un sejour avec cuisine integree et une machine a laver le linge, une salle d eau et un WC | T2

#Duree
#$JOUR_ENTREE | $MOIS_ENTREE | $ANNEE_ENTREE | $ANNEE_SORTIE_PREVUE | $DUREE_BAIL 
03 | Juillet | 2016 | 2019 | 3 
...
125,26 | 1eme trimestre 2016

#Donnees_Bailleur
#$IDENTITE_BAILLEUR | $ADRESSE_BAILLEUR
Sebastien Loisel | 11 allee des muriers 31700 Blagnac
#FinTraitement 
